...
import { Send, Loader2, AlertCircle, FileSpreadsheet } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container py-12">
        <div className="mx-auto max-w-3xl">
          ...
          {/* Tabs for Single/Batch Classification */}
          <Tabs defaultValue="single" className="animate-slide-up" style={{ animationDelay: '100ms' }}>
            ...
            <TabsContent value="single" className="space-y-6">
              ...
              {/* Error State */}
              {error && (
                <div className="animate-fade-in rounded-xl border border-destructive/20 bg-destructive/5 p-6">
            ...
            <TabsContent value="batch">
              <div className="rounded-xl border border-border bg-card p-6">
                <h3 className="font-serif text-lg font-semibold mb-4">Batch Classification</h3>
                <p className="text-sm text-muted-foreground mb-6">
                  Upload a CSV file with news articles (one per row) to classify them all at once.
                </p>
                <CSVUploader />
              </div>
            </TabsContent>
